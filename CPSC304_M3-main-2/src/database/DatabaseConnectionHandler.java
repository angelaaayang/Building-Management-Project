...
public class DatabaseConnectionHandler {
    ...
    public void databaseSetup() {
        ...
        Resident resident3 = new Resident("723206237", "Lewys Wright", "1989/05/03", 906);
        insertResident(resident3);

        Resident resident4 = new Resident("663244923", "Antoinette Lennon", "1995/06/15", 1502);
        insertResident(resident4);

        Resident resident5 = new Resident("969292102", "Anais Li", "1993/11/30", 1307);
        insertResident(resident5);
        ...
        DOBandAge dobandage3 = new DOBandAge("1989/05/03", 31);
        insertDOBandAge(dobandage3);

        DOBandAge dobandage4 = new DOBandAge("1995/06/15", 25);
        insertDOBandAge(dobandage4);

        DOBandAge dobandage5 = new DOBandAge("1993/11/30", 26);
        insertDOBandAge(dobandage5);
        ...
        Tenant tenant3 = new Tenant("723206237", 1799);
        insertTenant(tenant3);

        Tenant tenant4 = new Tenant("663244923", 1275);
        insertTenant(tenant4);
        ...
        Landlord landlord5 = new Landlord("969292102");
        insertLandlord(landlord5);
        ...
        GarbageRoom garbageroom3 = new GarbageRoom("Monday", "12321432", null);
        insertGarbageRoom(garbageroom3);

        Building building3 = new Building("12321432", "6168 Wilson Ave, Burnaby, BC, V5H 0B2");
        insertBuilding(building3);

        ParkingSpot parkingspot3 = new ParkingSpot("true", "23432136", "Lewys Wright", "6168 Wilson Ave, Burnaby, BC, V5H 0B2", 906, "723206237");
        insertParkingSpot(parkingspot3);

        GarbageRoom garbageroom4 = new GarbageRoom("Saturday", "09807799", null);
        insertGarbageRoom(garbageroom4);

        Building building4 = new Building("09807799", "3520 Crowley Drive, Vancouver, BC, V5R 6G9");
        insertBuilding(building4);

        ParkingSpot parkingspot4 = new ParkingSpot("true", "38163946", "Antoinette Lennon", "3520 Crowley Drive, Vancouver, BC, V5R 6G9", 1502, "663244923");
        insertParkingSpot(parkingspot4);

        GarbageRoom garbageroom5 = new GarbageRoom("Monday", "86857757", null);
        insertGarbageRoom(garbageroom5);

        Building building5 = new Building("86857757", "4371 Mayberry St, Burnaby, BC, V5H 4H8");
        insertBuilding(building5);

        ParkingSpot parkingspot5 = new ParkingSpot("true", "45678986", "Anais Li", "4371 Mayberry St, Burnaby, BC, V5H 4H8", 1307, "969292102");
        insertParkingSpot(parkingspot5);

        GarbageRoom garbageroom6 = new GarbageRoom("Monday", "23472983", null);
        insertGarbageRoom(garbageroom6);

        GarbageRoom garbageroom7 = new GarbageRoom("Sunday", "23816462", null);
        insertGarbageRoom(garbageroom7);
        ...
        Postman postman3 = new Postman("FedEx", "34889797", "Megan Wood");
        insertPostman(postman3);

        Postman postman4 = new Postman("Purolator", "56868076", "Ingrid Earle");
        insertPostman(postman4);

        Postman postman5 = new Postman("UPS", "13427965", "James Lee");
        insertPostman(postman5);

        Manager manager1 = new Manager("Jeremy Gill", "76864674", "7787791505");
        insertManager(manager1);

        Manager manager2 = new Manager("Sirena Harrop", "86656889", "7788792253");
        insertManager(manager2);

        Manager manager3 = new Manager("Kenny Nguyen", "98997557", "6046543342");
        insertManager(manager3);

        Manager manager4 = new Manager("Kenny Nguyen", "12534278", "6048872243");
        insertManager(manager4);

        Manager manager5 = new Manager("Simon Roberts", "85425645", "7786675543");
        insertManager(manager5);

        Manager manager6 = new Manager("Krystal Zhang", "03749322", "7787792836");
        insertManager(manager6);

        Manager manager7 = new Manager("Ashely Swift", "92638572", "7786675836");
        insertManager(manager7);
        ...
        Manage manage3 = new Manage("76864674", "3760 Alexander Rd, Richmond, BC, V6X 1C6");
        insertManage(manage3);

        Manage manage4 = new Manage("76864674", "6168 Wilson Ave, Burnaby, BC, V5H 0B2");
        insertManage(manage4);

        Manage manage5 = new Manage("12534278", "6168 Wilson Ave, Burnaby, BC, V5H 0B2");
        insertManage(manage5);

        Manage manage6 = new Manage("85425645", "4371 Mayberry St, Burnaby, BC, V5H 4H8");
        insertManage(manage6);

        Manage manage7 = new Manage("98997557", "3520 Crowley Drive, Vancouver, BC, V5R 6G9");
        insertManage(manage7);
        ...
        VideoServeillance videoserveillance3 = new VideoServeillance("68689943", 1, "3588 Crowley Drive, Vancouver, BC, V5R 6H3");
        insertVideoServeillance(videoserveillance3);

        VideoServeillance videoserveillance4 = new VideoServeillance("66689943", 5, "3588 Crowley Drive, Vancouver, BC, V5R 6H3");
        insertVideoServeillance(videoserveillance4);

        VideoServeillance videoserveillance5 = new VideoServeillance("68686743", 10, "3588 Crowley Drive, Vancouver, BC, V5R 6H3");
        insertVideoServeillance(videoserveillance5);

        VideoServeillance videoserveillance6 = new VideoServeillance("68640943", 15, "3588 Crowley Drive, Vancouver, BC, V5R 6H3");
        insertVideoServeillance(videoserveillance6);

        VideoServeillance videoserveillance7 = new VideoServeillance("68129943", 20, "3588 Crowley Drive, Vancouver, BC, V5R 6H3");
        insertVideoServeillance(videoserveillance7);

        VideoServeillance videoserveillance8 = new VideoServeillance("23986478", 1, "3760 Alexander Rd, Richmond, BC, V6X 1C6");
        insertVideoServeillance(videoserveillance8);

        VideoServeillance videoserveillance9 = new VideoServeillance("24560838", 5, "4371 Mayberry St, Burnaby, BC, V5H 4H8");
        insertVideoServeillance(videoserveillance9);

        VideoServeillance videoserveillance10 = new VideoServeillance("36675236", -3, "6168 Wilson Ave, Burnaby, BC, V5H 0B2");
        insertVideoServeillance(videoserveillance10);

        VideoServeillance videoserveillance11 = new VideoServeillance("36675936", 1, "6168 Wilson Ave, Burnaby, BC, V5H 0B2");
        insertVideoServeillance(videoserveillance11);
        ...
        Room room3 = new Room(906, "4371 Mayberry St, Burnaby, BC, V5H 4H8", "23432136");
        insertRoom(room3);

        Room room4 = new Room(1502, "3760 Alexander Rd, Richmond, BC, V6X 1C6", "38163946");
        insertRoom(room4);

        Room room5 = new Room(205, "3588 Crowley Drive, Vancouver, BC, V5R 6H3", "45678986");
        insertRoom(room5);
        ...
        Serve serve3 = new Serve("Canada Post", "24679383", "3760 Alexander Rd, Richmond, BC, V6X 1C6");
        insertServe(serve3);

        Serve serve4 = new Serve("Canada Post", "24679383", "6168 Wilson Ave, Burnaby, BC, V5H 0B2");
        insertServe(serve4);

        Serve serve5 = new Serve("Canada Post", "24679383", "3520 Crowley Drive, Vancouver, BC, V5R 6G9");
        insertServe(serve5);

        Serve serve6 = new Serve("Canada Post", "24679383", "4371 Mayberry St, Burnaby, BC, V5H 4H8");
        insertServe(serve6);

        Serve serve7 = new Serve("Canada Post", "24568987", "6168 Wilson Ave, Burnaby, BC, V5H 0B2");
        insertServe(serve7);

        Serve serve8 = new Serve("FedEx", "34889797", "6168 Wilson Ave, Burnaby, BC, V5H 0B2");
        insertServe(serve8);

        Serve serve9 = new Serve("Purolator", "56868076", "3520 Crowley Drive, Vancouver, BC, V5R 6G9");
        insertServe(serve9);

        Serve serve10 = new Serve("UPS", "13427965", "4371 Mayberry St, Burnaby, BC, V5H 4H8");
        insertServe(serve10);
        ...
        updateGarbageRoom( "Monday", "12321432", "6168 Wilson Ave, Burnaby, BC, V5H 0B2");

        updateGarbageRoom("Saturday","09807799", "3520 Crowley Drive, Vancouver, BC, V5R 6G9");

        updateGarbageRoom( "Monday", "86857757", "4371 Mayberry St, Burnaby, BC, V5H 4H8");
